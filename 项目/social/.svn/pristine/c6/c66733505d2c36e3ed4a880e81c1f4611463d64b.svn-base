...
//    
////    if (isNew) {
////        frameToCenter.origin.y = frameToCenter.origin.y + 64;
////    }
//    // center vertically
...
- (void)setImageToCrop:(UIImage *)imageToCrop{
    ...
    self.scrollView.contentSize = CGSizeMake(kPickerHeight, kPickerWidth / imageToCrop.size.width *imageToCrop.size.height);
}
...
//    }
    ...
    self.scrollView.frame = CGRectMake(xOffset, yOffset, kPickerWidth, kPickerHeight);
    scrollView.contentOffset = CGPointMake(0, 0);
//    self.scrollView.contentSize = CGSizeMake(size.width, size.height);
    
//    self.scrollView.contentOffset = CGPointMake(0, (faktoredHeight - 100) / 2.0);
