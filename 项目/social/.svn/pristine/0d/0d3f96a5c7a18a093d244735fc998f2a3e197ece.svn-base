...
- (void) setImage:(id)imagePhoto
{
    //start
    if (shopMangeFlag == YES) {
        if (imagePhoto) {
            HWPhoto *imagePhotoImage = (HWPhoto *)imagePhoto;
            //获取数据
                UIImage *imageTemp = imagePhotoImage.localPhotoImage;
                imgView.image = imageTemp;
                imgSize = imageTemp.size;
    ...
    else
    {
        if (imagePhoto)
        {
            UIImage *imageTemp = (UIImage *)imagePhoto;
            imgView.image = imageTemp;
            imgSize = imageTemp.size;
