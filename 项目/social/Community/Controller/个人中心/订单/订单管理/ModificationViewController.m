...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *identify = [NSString stringWithFormat:@"identify%d",indexPath.row];
...
- (void)saveAction{
    ...
    [dict setPObject:addressid forKey:@"id"];
    ...
    [manage POST:kEditAddress parameters:dict queue:nil success:^(id responseObject) {
        NSLog(@"保存成功");
...
//        if ([subViews[i] isKindOfClass:[UITextField class]]||[subViews[i] isKindOfClass:[UITextView class]]) {
//            [subViews[i] resignFirstResponder];
//            
//        }
//        
//    }
