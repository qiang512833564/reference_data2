...
- (void)viewDidLoad
{
    ...
    _loginBtn.frame = CGRectMake(25.0f, CGRectGetMaxY(_passwordTF.frame) + 40, kScreenWidth - 50, 45);
    ...
    UILabel *forgetLab = [[UILabel alloc] initWithFrame:CGRectMake(25.0f, CGRectGetMaxY(_loginBtn.frame) + 15, 100, 25)];
...
- (void)doForget:(id)sender
{
    ...
    [self sendCode:self.telephone];
}

- (void)sendCode:(NSString *)phoneNum
{
