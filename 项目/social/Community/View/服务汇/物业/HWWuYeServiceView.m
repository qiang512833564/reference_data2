...
- (void)loadUIForCompany
{
    ...
    DLable *singLab = [DLable LabTxt:@"认证物业" txtFont:TF12 txtColor:THEME_COLOR_White frameX:titleLab.frame.origin.x y:CGRectGetMaxY(titleLab.frame) + 5 w:60 h:22];
    singLab.textAlignment = NSTextAlignmentCenter;
    singLab.backgroundColor = UIColorFromRGB(0xfec92f);
    singLab.layer.borderColor = THEME_COLOR_LINE.CGColor;
    singLab.layer.borderWidth = 0.3f;
    singLab.layer.cornerRadius = 10;
    singLab.layer.masksToBounds = YES;
    [backImg addSubview:singLab];
...
- (void)loadUIForUnCompany
{
    ...
    NSString *villageStr = [HWUserLogin currentUserLogin].villageName;
    DLable *titleLab = [DLable LabTxt:villageStr txtFont:TF18 txtColor:THEME_COLOR_White frameX:CGRectGetMaxX(headImg.frame) + 10 y:37 w:kScreenWidth - 2 * 15 - 40 - 55 - 10 h:20];
    [backImg addSubview:titleLab];
