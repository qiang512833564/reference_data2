...
#define kSublayerRadius (13.f)
#define KWeekName (@"ArialMT Regular")
#define kAnimationDuration 0.12
#define kScale (667/2200.f)
#define kPink [UIColor colorWithRed:235/255.0 green:54/255.0 blue:130/255.0 alpha:1.0]
...
@property (strong, nonatomic) UIView *animLayer;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleLabel.font = [UIFont fontWithName:kDayName size:48*kScale];
        ...
        _animLayer = [[UIView alloc]initWithFrame:CGRectZero];
        [self insertSubview:_animLayer belowSubview:_titleLabel];
...
- (void)layoutSublayersOfLayer:(CALayer *)layer
{
    ...
    if (layer == self.layer) {
       // CGFloat diameter = self.diameter;
        ...
        _animLayer.frame = CGRectMake(self.fs_width/2.f-kSublayerRadius, self.fs_height/2.f-kSublayerRadius, kSublayerRadius*2.f, kSublayerRadius*2.f);
        _animLayer.layer.cornerRadius = kSublayerRadius;
        _animLayer.layer.masksToBounds = YES;
//        switch (self.style) {
...
//                break;
//        }
        _animLayer.backgroundColor = [self unitColorForState:self.absoluteState];
        
        
        _eventLayer.frame = _animLayer.frame;
        _eventLayer.fillColor = [UIColor clearColor].CGColor;
        _eventLayer.borderColor = kPink.CGColor;
        _eventLayer.masksToBounds = YES;
        _eventLayer.cornerRadius = kSublayerRadius;
        _eventLayer.borderWidth = 0.7;
        _eventLayer.path = [UIBezierPath bezierPathWithOvalInRect:_eventLayer.bounds].CGPath;
...
- (void)showAnimation
{
    ...
    if (_animation == FSCalendarUnitAnimationScale) {
        ...
        [_animLayer.layer addAnimation:group forKey:@"bounce"];
