...
//** UMENG 时间统计 ***********************************************************************************
#define Launch      @"EVT1001"
#define Login       @"EVT1002"
#define ZHTL        @"EVT1003"
#define YPTJ        @"EVT1004"
#define Signin      @"EVT1005"
#define PersonPage  @"EVT1006"
#define ScanStory   @"EVT1007"
#define MJQ         @"EVT1008"
#define MJQ_D       @"EVT1009"

#define ColorIndex  @"themeColor"

//** 错误提示 ***********************************************************************************
#define ERRORMSG1 @"服务器工程师睡着啦!"
#define ERRORMSG2 @"网络连接异常"
#define SUCCESSCODE 0000
#define TIMELENGTH  1.5
#define USER       @"user"

#define REMINDTEXT1 @"努力加载中..."
#define REMINDTEXT2 @"网络不给力"
#define REMINDTEXT3 @"服务器繁忙"
//** 沙盒路径 ***********************************************************************************
...
#define GREENCOLOR       [UIColor colorWithRed:(0.133) green:(0.757) blue:(0.988) alpha:1]
#define REDCOLOR         [UIColor colorWithRed:(0.925) green:(0.212) blue:(0.506) alpha:1]
#define GRAYCOLOR        [UIColor colorWithRed:(0.400) green:(0.400) blue:(0.400) alpha:1]
#define WHITECOLOR       [UIColor colorWithRed:(0.855) green:(0.855) blue:(0.855) alpha:1]
#define BLACKCOLOR       [UIColor colorWithRed:(0.133) green:(0.133) blue:(0.133) alpha:1]
