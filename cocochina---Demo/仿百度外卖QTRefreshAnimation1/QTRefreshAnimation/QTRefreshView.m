...
//    [path addLineToPoint:CGPointMake(0, 0)];
    ...
    [path addQuadCurveToPoint:CGPointMake(self.frame.size.width, 0) controlPoint:CGPointMake(self.frame.size.width/2,-_offsetY*1.2)];//这里是负的_offsetY，是因为当向下拖动tableview的时候_offsetY是负数，因此需要转换成正数
//    // 添加一条直线，从初始点到该函数指定的坐标点
