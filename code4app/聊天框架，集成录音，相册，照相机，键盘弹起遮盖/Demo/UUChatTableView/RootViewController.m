...
-(void)keyboardChange:(NSNotification *)notification
{
    ...
    [[userInfo objectForKey:UIKeyboardAnimationCurveUserInfoKey] getValue:&animationCurve];//获得键盘弹起的动画
    [[userInfo objectForKey:UIKeyboardAnimationDurationUserInfoKey] getValue:&animationDuration];//获取键盘弹起动画的周期
    [[userInfo objectForKey:UIKeyboardFrameEndUserInfoKey] getValue:&keyboardEndFrame];//获取键盘弹起动画结束的frame
