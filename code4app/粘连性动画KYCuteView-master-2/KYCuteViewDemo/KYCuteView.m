...
-(void)setUp{
    ...
    self.frontView.backgroundColor = [UIColor blueColor];//self.bubbleColor;
    
    backView = [[UIView alloc]initWithFrame:self.frontView.frame];
    r1 = backView.bounds.size.width / 2;
    backView.layer.cornerRadius = r1;
    backView.backgroundColor = [UIColor redColor];//self.bubbleColor
    ...
    //self.bubbleLabel.backgroundColor = [UIColor blackColor];
